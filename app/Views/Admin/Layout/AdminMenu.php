<?php
  $current_uri = uri_string(); // Mendapatkan URI saat ini, misal: 'Kategori'
?>
<?= $this->section('menu');?>
   
 
 <li class="nav-item">
   <a class="nav-link  <?= $current_uri == 'Kategori' ? 'active' : '' ?>" href="<?= site_url('Kategori') ?>" href="<?= site_url('Kategori')?>">
 ...
 <li class="nav-item">
          <a class="nav-link  <?= $current_uri== 'Penjualan'? 'active': '' ?> " href="<?= site_url('Penjualan')?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 <li class="nav-item">
          <a class="nav-link  <?= $current_uri == 'Produk' ? 'active' : '' ?>" href="<?= site_url('Produk') ?>" href="<?= site_url('Produk')?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 <li class="nav-item">
          <a class="nav-link  " href="<?= site_url('Admin/Menu/MenuKategori')?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 <li class="nav-item">
          <a class="nav-link  " href="<?= site_url('Admin/Menu/MenuKategori')?>">
            ...
            <span class="nav-link-text ms-1">Data Review</span>
          </a>
        </li>
 ...
 <li class="nav-item">
          <a class="nav-link  " href="<?= site_url('Admin/Menu/MenuKategori')?>">
            ...
            <span class="nav-link-text ms-1">Data Konsumer</span>
          </a>
        </li>
